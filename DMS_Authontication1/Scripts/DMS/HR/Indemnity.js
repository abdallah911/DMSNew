    ...
    $('#submit').click(function () {
        ...
        if (result.valid) {
            ...
            if ($("#Type").val() == "2") {
                ...
                indemnty.CompanyName = $('#CompanyName').val();
            } else {//==1
                indemnty.CardID = $('#CardID').val();
                indemnty.EmployeeName = $('#EmployeeName').val();
                indemnty.NationalID = $('#NationalID').val();
            }
            var files = [];
                ...
                for (var i = 0; i < Cardfiles.length; i++) {
                    ...
                    for (var x in CardServicesArray) {
                        if (CardServicesArray[x].CardId == row.find("TD").eq(0).html()) {
                            CardServicesArray[x].AttachPDF += "/Content/IndemnitiesAttachments/" + Cardfiles[i].name + ",";
                            break;
                        }
                    }
