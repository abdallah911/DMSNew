                                ...
                                success: function (returndata) {
                                    if (returndata.ok) {
                                        $.ajax({
                                            ...
                                            data: { id: CompId, CardId: $('#txtSearchCard').val() },
                                            success: function (returndatacom) {
                                                if (returndatacom.ok) {
                                                    debugger;
                                                    if (returndatacom.data == "Yes") {
                                                        ...
                                                        if ((r.Data[0].HOSPITAL_DEGREE <= r.Data[0].Provider_Level || r.messages == "ok") && r.messageblackwhite == "ok") {
                                                            if (r.Data[0].TERMINATE_FLAG == 'N' || r.Data[0].TERMINATE_FLAG == null) {
                                                                ...
                                                                if (r.Data[0].TERMINATE_DATE != null && r.Data[0].TERMINATE_DATE >= r.Data[0].Now) {
                                                                    if (r.Data[0].INS_END_DATE != null) {
                                                                        //end date
                                                                        var MyDate_String_Value1 = r.Data[0].INS_END_DATE;
                                                                        var MyDate_String_Value2 = r.Data[0].INS_START_DATE;
                                                    ...
                                                    else if (returndatacom.data == "Expire") {
                                                        $("#wait").css("display", "none");
                                                        bootbox.dialog({
                                                            title: 'Alert!',
                                                            message: returndatacom.message,
