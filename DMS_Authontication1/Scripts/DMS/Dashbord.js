...
function updatCard(url = '') {
    ...
    if (url == '') {
        const isAll = document.getElementById("AllContract").classList.contains("active");
        url = isAll ? '/Dashboard/getLiveCard' : '/Dashboard/getLiveCardMonth';
    }
...
function ChartLiveScreen() {
    ...
    destroyCanvasChart(pie4);
    destroyCanvasChart(graphSix);
    destroyCanvasChart(graphFive);
    destroyCanvasChart(graph11);
                    ...
                    datasets: [
                        {
                            ...
                            data: grossValues,
                            backgroundColor: '#724494',
                            borderColor: '#7244942b',
                          borderWidth: 5,
                            borderRadius: 5,
                            borderSkipped: false,
                            yAxisID: 'amount'
                        },
                        {
                            ...
                            data: netValues,
                            backgroundColor: '#a683be',
                            borderColor: '#8b63a62b',
                          borderWidth: 5,
                            borderRadius: 5,
                            borderSkipped: false,
                            yAxisID: 'amount'
...
function ChartLiveScreenMonth() {
    ...
    updatCard('/Dashboard/getLiveCardMonth');
    ...
    new Chart(graph34, {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: true,
                backgroundColor: '#7244943d',
                borderColor: '#724494',
                pointBackgroundColor: 'white',
                pointBorderColor: '#7244945c',
                pointRadius: 5,
                tension: 0.4,
              borderWidth: 5
            }]
        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    backgroundColor: '#6ebaed',
                    borderColor: '#6ebaed2b',
                  borderWidth: 2,
                    borderRadius: 5,
                    borderSkipped: false, 
                },
