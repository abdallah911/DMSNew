...
$(function () {
    ...
    $('#adminSearch').click(function () {
        ...
        if (result.valid) {
            ...
            $("#Index").DataTable({
                "sAjaxSource": '/PharmacyAdmin/PreseptionList?Provider=' + $("#Provider").val() + '&&Company=' + $("#Company").val() + '&&ApprovalNo=' + $("#ApprovalNo").val() + '&&Branch=' + $("#Branch").val() + '&&CardId=' + $("#CardId").val() + '&&Type=' + $("#ddlType").val() + '&&From=' + $("#AdminFrom").val() + '&&To=' + $("#AdminTo").val(),
                "bServerSide": true,
                "processing": true,
                "bFilter": true,
                "bSort": false,
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "mRender": function (data) {
                            ...
                            return '<a class="btn btn-warning" href="/PharmacyAdmin/Edit/' + data + '">Edit</a>';
                        }
                    },
                    {
                        "data": "Id",
                        "mRender": function (data) {
                            //data = data.toString().slice(8);//remove date
                            return '<a class="btn btn-info" href="/PharmacyAdmin/Details/' + data + '">Details</a>';
                        }
                    }
                    ,
                    {
