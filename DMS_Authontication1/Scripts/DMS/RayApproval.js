            ...
            if (row.val != "") {
                if (TotalDuration != 0) {
                    if (Mediciens.length != 0) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '/RayApprovals/SavePrescription/',
                            dataType: 'Json',
...
function SelectLab(event) {
    ...
    $.ajax({
        ...
        $.ajax({
            ...
            ,
            error: function (r) {
                bootbox.alert("Failed to retrieve Ray Data,please Check your Internet connection  ");
            },
            success: function (r) {
                if (r != 1) {
