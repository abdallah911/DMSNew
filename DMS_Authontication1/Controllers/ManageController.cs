    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (CurrentUser.EmailConfirmed == false)
            {
                ...
                ModelState.AddModelError("", "Email Must be Confirmed");
                return View(model);
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangeUserPassword(ChangePasswordViewModel model,string id)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        public async Task<ActionResult> SetEmail(SetEmailViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Index", new { Message = ManageMessageId.SetEmailSuccess });
                }
                AddErrors(result);
            }
