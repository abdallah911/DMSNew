...
$(document).ready(function () {
    ...
    $('#add').click(function () {
        ...
        if (isAllValid) {
            ...
            $('#productCategory,#product,#quantity,#rate,#add,#m_Code,#name,#Dosage,#Package_Size,#Package_price,#unit_number,#Dose,#Duration,#totalDuration,#Amount,#Group', $newRow).removeAttr('id');
            ...
            $('#quantity,#rate,#m_Code,#name,#Dosage,#Package_Size,#Package_price,#unit_number,#Dose,#Duration,#totalDuration,#Amount,#Group').val('');
    ...
    $('#submit').click(function () {
        ...
        $('#orderdetailsItems tbody tr').each(function (index, ele) {
            if (
                ...
                (parseInt($('.Duration', this).val()) || 0) == 0 ||
                $('.totalDuration', this).val() == "" ||
                isNaN($('.Dose', this).val())
                ) {
                errorItemCount++;
                $(this).addClass('error');
