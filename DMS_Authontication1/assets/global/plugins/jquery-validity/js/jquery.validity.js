...
(function($) {
    ...
    $.validity.outputs.label = {
        ...
        start:function() {
            ...
            $('span.help-block:not(.noremove)').remove();
        },
        ...
        raise:function($obj, msg) {
            ...
            // Otherwize create a new one and stick it after the input:
                ...
                $("<span/>")
                    ...
                    .insertAfter(($obj.parents().hasClass('input-group') ? $obj.parents('.input-group') : ($obj.hasClass('select2-hidden-accessible') ? $obj.parent().find('span.select2') : $obj)));
            }
